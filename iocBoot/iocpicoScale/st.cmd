...
dbLoadRecords ("db/picoScale_Channel_Common.db", "Ch=3, C=CATERETE:, P=PICOSCALE:, PORTNAME=eth0, ADDRESS=0, TIMEOUT=1")
...
#dbLoadRecords ("db/picoScale_Adjustment.db", "C=CATERETE:, P=PICOSCALE:")
