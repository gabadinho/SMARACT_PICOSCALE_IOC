...
/* Generated from ../O.Common/picoScale.dbd */
...
epicsShareExtern void (*pvar_func_drvPicoScaleRegister)(void);
epicsShareExtern void (*pvar_func_initPicoScaleRegister)(void);
...
int picoScale_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/ABTLUS/allan.bugyi/work/dev/iocs/SMARACT_PICOSCALE_IOC";
    ...
    (*pvar_func_drvPicoScaleRegister)();
    (*pvar_func_initPicoScaleRegister)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"picoScale_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    picoScale_registerRecordDeviceDriver(*iocshPpdbbase);
}
